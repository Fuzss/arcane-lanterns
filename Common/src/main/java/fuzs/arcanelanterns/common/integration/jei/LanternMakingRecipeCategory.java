package fuzs.arcanelanterns.common.integration.jei;
...
public class LanternMakingRecipeCategory extends AbstractRecipeCategory<RecipeHolder<LanternMakingRecipe>> {
    ...
    @Override
    public void draw(RecipeHolder<LanternMakingRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
